...
<strong>*Initializing this will also start checking and downloading the PayMEMiniApp version, so it is recommended to initialize it as early as possible when running the app.*<strong>
